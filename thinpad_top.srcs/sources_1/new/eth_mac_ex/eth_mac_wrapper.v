...
module eth_mac_wrapper (
    ...
    (*MARK_DEBUG="TRUE"*)input tx_axis_fifo_tvalid,
    (*MARK_DEBUG="TRUE"*)input [7:0] tx_axis_fifo_tdata,
    (*MARK_DEBUG="TRUE"*)input tx_axis_fifo_tlast,
    (*MARK_DEBUG="TRUE"*)output tx_axis_fifo_tready
);
