...
module thinpad_top(
    ...
    input wire clock_btn,         //BTN5鎵嬪姩鏃堕挓鎸夐挳寮?鍏筹紝甯︽秷鎶栫數璺?锛屾寜涓嬫椂涓?1
    input wire reset_btn,         //BTN6鎵嬪姩澶嶄綅鎸夐挳寮?鍏筹紝甯︽秷鎶栫數璺?锛屾寜涓嬫椂涓?1

    input  wire[3:0]  touch_btn,  //BTN1~BTN4锛屾寜閽?寮?鍏筹紝鎸変笅鏃朵负1
    ...
    input wire uart_tbre,         //鍙戦?佹暟鎹?鏍囧織
    ...
    output wire base_ram_ce_n,       //BaseRAM鐗囬?夛紝浣庢湁鏁?
    ...
    output wire ext_ram_ce_n,       //ExtRAM鐗囬?夛紝浣庢湁鏁?
    ...
    output wire flash_ce_n,         //Flash鐗囬?変俊鍙凤紝浣庢湁鏁?
...
assign axis_fifo_wr_en = eth_rx_axis_mac_tvalid;
